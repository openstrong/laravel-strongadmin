...
<div class="layui-container st-body">
    <div class="layui-btn-container">
        <a class="layui-btn layui-btn-xs" onclick="Util.createFormWindow('/strongadmin/adminMenu/create?parent_name=顶级菜单', this.innerText);">添加一级菜单</a>
        @if(request('down'))
    ...
    <table class="layui-table st-tree" lay-size="sm" lay-skin="nob" id="ST-TREE">
        ...
        <tbody>
            ...
            <tr data-level="{{$loop->iteration}}" data-indent="0" data-open="0">
                ...
                <td>
                    <a class="layui-btn layui-btn-xs" onclick="Util.createFormWindow('/strongadmin/adminMenu/create?level=2&parent_id={{$row->id}}&parent_name={{$row->name}}', this.innerText);">添加</a>
                    <a class="layui-btn layui-btn-xs layui-btn-normal" onclick="Util.createFormWindow('/strongadmin/adminMenu/update?id={{$row->id}}&parent_name=顶级菜单', this.innerText);">更新</a>
                    <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="Util.destroy('/strongadmin/adminMenu/destroy?id={{$row->id}}');">删除</a>
                </td>
            </tr>
            ...
            <tr data-level="{{$loop->parent->iteration}}-{{$loop->iteration}}" data-indent="1" data-open="0" class="layui-hide">
                ...
                <td>
                    <a class="layui-btn layui-btn-xs" onclick="Util.createFormWindow('/strongadmin/adminMenu/create?level=3&parent_id={{$child->id}}&parent_name={{$child->name}}', this.innerText);">添加</a>
                    ...
                    <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="Util.destroy('/strongadmin/adminMenu/destroy?id={{$child->id}}');">删除</a>
                </td>
            </tr>
            ...
            <tr data-level="{{$loop->parent->parent->iteration}}-{{$loop->parent->iteration}}-{{$loop->iteration}}" data-indent="2" data-open="-1" class="layui-hide">
                ...
                <td>
                    ...
                    <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="Util.destroy('/strongadmin/adminMenu/destroy?id={{$child2->id}}&parent_name={{$child2->parent->name}');">删除</a>
                </td>
            </tr>
            @endforeach
            @endforeach
